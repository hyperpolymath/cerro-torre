...
*Phase 2 - Complete:* Registry fetch/push working, cloud testing pending. *78% complete*
...
* ✅ *CLI Framework*: `ct fetch` and `ct push` working live, `ct pack`/`ct verify` complete
...
* ✅ *ct push*: Successfully uploads bundles to Docker registries
* ✅ *Localhost registries*: HTTP auto-detection, port parsing fixed, round-trip verified
* 📋 *Cloud registries*: ghcr.io and docker.io ready for testing (authentication required)
...
* [ ] Implement Ed25519 signing (openssl wrapper for MVP)
* [ ] Submit test attestation to Rekor
* [ ] Make HTTP debug logging configurable (currently always-on)
