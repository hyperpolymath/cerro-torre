...
* ✅ *HTTP Client (CT_HTTP)*: Curl-based client with TLS, auth, modern protocol support, configurable debug logging
...
* ✅ *Ed25519 Signing*: OpenSSL-based signing module (keygen, sign operations ready)
...
* [ ] Test signing end-to-end (generate key → sign bundle → verify)
